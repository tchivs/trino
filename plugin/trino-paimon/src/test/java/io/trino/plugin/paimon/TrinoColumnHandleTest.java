...
public class TrinoColumnHandleTest
{
    ...
    {
        assertThatThrownBy(() -> PaimonColumnHandle.of("name", DataTypes.STRING(),
                (io.trino.spi.type.TypeManager) null))
    ...
    {
        PaimonColumnHandle expected = PaimonColumnHandle.of("variant_value", DataTypes.VARIANT(),
    ...
    {
        PaimonColumnHandle expected = PaimonColumnHandle.of("variant_values", DataTypes.ARRAY(DataTypes.VARIANT()),
                TESTING_TYPE_MANAGER);

        testRoundTrip(expected);

        assertThatThrownBy(() -> PaimonColumnHandle.of("variant_values", DataTypes.ARRAY(DataTypes.VARIANT()),
                new io.trino.spi.type.ArrayType(VARCHAR)))
                .hasMessage("trinoType must match Paimon type mapping");
    }
    ...
    public void testExplicitAnonymousRowTypeMatchesStablePaimonFieldNames()
    {
        ...
        PaimonColumnHandle handle = PaimonColumnHandle.of("row_value", logicalType,
