...
class PaimonKeyDynamicBootstrapTest
{
            ...
            throws Exception
    {
        ...
        org.apache.paimon.fs.FileIO fileIO = LocalFileIO.create();
        ...
        byte[] bytes;
        try (java.io.InputStream input = fileIO.newInputStream(path)) {
            ...
            throws Exception
    {
        ...
        try {
            writer.write(org.apache.paimon.data.GenericRow.of(key, fromString("value-" + key)));
            ...
            throws Exception
    {
        ...
        InnerTableCommit commit = table.newCommit(commitUser);
        try {
            writer.write(org.apache.paimon.data.GenericRow.of(
                    key,
