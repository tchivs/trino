...
public class TrinoRowTest
{
    ...
    void test()
    {
        ...
        List<Type> types = List.of(BOOLEAN, BOOLEAN, TINYINT, SMALLINT, INTEGER, BIGINT, REAL, DOUBLE, VARCHAR,
                ...
                DecimalType.createDecimalType(10, 1), TIMESTAMP_MICROS, VARBINARY, JSON_TYPE);
    ...
    void testConstructorRejectsNullPageAndRowKind()
    {
        ...
        assertThatThrownBy(() -> new PaimonRow(new Page(1, writeNativeValue(INTEGER, 1L)), null,
    ...
    void testVariantRequiresJsonTypeMetadata()
    {
        ...
        PaimonRow trinoRow = new PaimonRow(singlePage, RowKind.INSERT, List.of(VARCHAR),
    ...
    void testInvalidVariantJsonKeepsParseFailureContext()
    {
        ...
        PaimonRow trinoRow = new PaimonRow(singlePage, RowKind.INSERT, List.of(JSON_TYPE),
                List.of(DataTypes.VARIANT()));
    ...
    void testRowConversionValidatesRequestedFieldCount()
    {
        ...
        PaimonRow trinoRow = new PaimonRow(new Page(1, writeNativeValue(rowType, row)), RowKind.INSERT,
                List.of(rowType), List.of(DataTypes.ROW(
    ...
    void testNestedRowConversionValidatesRequestedFieldCount()
    {
        ...
        SqlRow outerRow = buildRowValue(outerRowType,
                fieldBuilders -> writeNativeValue(innerRowType, fieldBuilders.get(0), innerRow));
        PaimonRow trinoRow = new PaimonRow(new Page(1, writeNativeValue(outerRowType, outerRow)), RowKind.INSERT,
                List.of(outerRowType), List.of(DataTypes.ROW(DataTypes.FIELD(0, "nested", DataTypes.ROW(
                        DataTypes.FIELD(0, "f0", DataTypes.INT()),
                        DataTypes.FIELD(1, "f1", DataTypes.STRING()))))));
    ...
    void testNestedMultisetConversionUsesElementAndCountTypes()
    {
        ...
        PaimonRow trinoRow = new PaimonRow(new Page(1, writeNativeValue(rowType, row)), RowKind.INSERT,
                List.of(rowType), List.of(DataTypes.ROW(DataTypes.FIELD(0, "tags",
    ...
    void testVectorConversionUsesArrayBlock()
    {
        ...
        PaimonRow trinoRow = new PaimonRow(new Page(1, writeNativeValue(vectorType, vector)), RowKind.INSERT,
                List.of(vectorType), List.of(DataTypes.VECTOR(3, DataTypes.FLOAT())));
    ...
    void testNestedVectorConversionValidatesPaimonLogicalLength()
    {
        ...
        PaimonRow trinoRow = new PaimonRow(new Page(1, writeNativeValue(rowType, row)), RowKind.INSERT,
                List.of(rowType), List.of(new org.apache.paimon.types.RowType(List.of(
    ...
    void testArrayOfVectorConversionValidatesPaimonLogicalLength()
    {
        ...
        Block arrayOfVector = buildArrayValue(arrayOfVectorType, 1,
                elementBuilder -> writeNativeValue(vectorType, elementBuilder, shortVector));

        PaimonRow trinoRow = new PaimonRow(new Page(1, writeNativeValue(arrayOfVectorType, arrayOfVector)),
                RowKind.INSERT, List.of(arrayOfVectorType),
    ...
    void testMapValueVectorConversionValidatesPaimonLogicalLength()
    {
        ...
        PaimonRow trinoRow = new PaimonRow(new Page(1, writeNativeValue(mapType, map)), RowKind.INSERT,
                List.of(mapType), List.of(DataTypes.MAP(DataTypes.INT(), DataTypes.VECTOR(3, DataTypes.FLOAT()))));
    ...
    private static void assertVectorConversion(Type elementType, DataType elementLogicalType,
            java.util.function.Consumer<BlockBuilder> writeElements,
            java.util.function.Consumer<InternalVector> assertVector)
    {
        ArrayType vectorType = new ArrayType(elementType);
        Block vector = buildArrayValue(vectorType, 3, writeElements::accept);
        PaimonRow trinoRow = new PaimonRow(new Page(1, writeNativeValue(vectorType, vector)), RowKind.INSERT,
                List.of(vectorType), List.of(DataTypes.VECTOR(3, elementLogicalType)));
