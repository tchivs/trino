...
public class PaimonMetadataTableModeTest
{
    ...
    public void testSystemSchemaDdlAndAlterOperationsAreRejected()
    {
        ...
        assertTrinoError(
                () -> metadata.addColumn(SESSION, systemTableHandle, new ColumnMetadata("extra", INTEGER), new io.trino.spi.connector.ColumnPosition.Last()),
                NOT_SUPPORTED.toErrorCode(),
    ...
    public void testDdlEntrypointsRejectNullSessionBeforeCatalogInitialization()
    {
        ...
        assertThatThrownBy(() -> metadata.dropTable(null, tableHandle))
                .isInstanceOf(NullPointerException.class)
                .hasMessage("session is null");
        assertThatThrownBy(() -> metadata.addColumn(null, tableHandle, new ColumnMetadata("value", INTEGER), new io.trino.spi.connector.ColumnPosition.Last()))
                .isInstanceOf(NullPointerException.class)
                .hasMessage("session is null");
    ...
    public void testDdlRejectsCaseInsensitiveDuplicateColumnTargets()
    {
        ...
        assertTrinoError(
                () -> metadata.addColumn(SESSION, tableHandle, new ColumnMetadata("payload", VARCHAR), new io.trino.spi.connector.ColumnPosition.Last()),
    ...
    public void testDdlRejectsMalformedArgumentsBeforeCatalogAlter()
    {
        ...
        assertThatThrownBy(() -> metadata.addColumn(SESSION, tableHandle, null, new io.trino.spi.connector.ColumnPosition.Last()))
                .isInstanceOf(NullPointerException.class)
    ...
    public void testDdlErrorsUseTrinoErrorCodes()
    {
        ...
        assertTrinoError(
                ...
                "Table 'schema.table' does not exist");
        assertTrinoError(
                () -> metadata.addColumn(SESSION, tableHandle, new ColumnMetadata("existing", INTEGER), new io.trino.spi.connector.ColumnPosition.Last()),
                COLUMN_ALREADY_EXISTS.toErrorCode(),
    ...
    {
        org.apache.paimon.types.RowType rowType = DataTypes.ROW(DataTypes.FIELD(
                0,
                "too_long",
    ...
    public void testAddColumnRejectsNotNullBeforeCatalogAlter()
    {
        ...
        assertTrinoError(
                () -> metadata.addColumn(SESSION, tableHandle, column, new io.trino.spi.connector.ColumnPosition.Last()),
                NOT_SUPPORTED.toErrorCode(),
    ...
    private static void assertSetColumnTypePreservesExistingPaimonNullability(
            org.apache.paimon.types.DataType existingType,
    ...
    private static FileStoreTable fileStoreTable(
            ...
            org.apache.paimon.types.RowType latestRowType)
    {
