        ...
        Optional<Integer> parquetPageValueCountLimit)
{
    ...
    {
        blockSizeBytes = requireNonNull(blockSizeBytes, "blockSizeBytes is null");
        parquetPageSizeBytes = requireNonNull(parquetPageSizeBytes, "parquetPageSizeBytes is null");
        parquetPageValueCountLimit = requireNonNull(parquetPageValueCountLimit, "parquetPageValueCountLimit is null");
    }
