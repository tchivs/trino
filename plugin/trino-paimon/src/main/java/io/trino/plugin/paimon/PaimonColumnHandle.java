        ...
        ColumnHandle
{
    ...
    @JsonCreator
    public PaimonColumnHandle(@JsonProperty(value = "columnName", required = true) String columnName,
    ...
    {
        return new PaimonColumnHandle(columnName, JsonSerdeUtil.toJson(requireNonNull(columnType, "columnType is null")),
                trinoType, false);
    }
    ...
    static boolean matchesTrinoType(DataType logicalType, Type trinoType)
    {
        ...
        return switch (logicalType.getTypeRoot()) {
            ...
            case MULTISET -> trinoType instanceof MapType mapType
                    ...
                    && mapType.getValueType().equals(PaimonTypeUtils.fromPaimonType(new org.apache.paimon.types.IntType()));
